...
@endphp
<a href="{{ route('blog.show', $post) }}" class="card overflow-hidden group hover:shadow-lg transition flex flex-col">
    <div class="aspect-[16/10] overflow-hidden relative">
        <img src="{{ $imageUrl }}" alt="{{ $post->title }}" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
