    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <aside class="card p-6 h-fit">
            ...
            <div class="mt-5 pt-5 border-t border-ink-100 text-xs text-ink-500 space-y-2">
                <p class="flex items-center gap-2"><x-icon name="phone" class="w-4 h-4 text-brand-600" /> +92 321 5381128</p>
                <p class="flex items-center gap-2"><x-icon name="envelope" class="w-4 h-4 text-brand-600" /> rafayshahid0890@gmail.com</p>
