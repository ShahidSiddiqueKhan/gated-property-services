...
@section('content')
    ...
    <section class="py-16 bg-white">
        <div class="max-w-5xl mx-auto px-6 grid lg:grid-cols-3 gap-10">
            ...
            <aside class="card p-6 h-fit" data-reveal data-reveal-delay="2">
        ...
        <div class="max-w-5xl mx-auto px-6 mt-16 pt-10 border-t border-ink-100">
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                @foreach ($related as $r)
                    <a href="{{ route('services.show', $r) }}" class="card p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300" data-reveal data-reveal-delay="{{ min($loop->iteration, 6) }}">
