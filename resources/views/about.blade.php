...
@section('content')
    ...
    <section class="bg-ink-950 text-white py-20">
    ...
    <section class="py-20 bg-ink-50">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <img src="https://images.unsplash.com/photo-1560184897-ae75f418493e?auto=format&fit=crop&w=1200&q=80" class="rounded-2xl shadow-xl w-full aspect-[4/3] object-cover" alt="GATED team">
        </div>
    </section>
    ...
    <section class="py-16 bg-ink-950 text-white">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div><div class="text-3xl font-heading font-extrabold text-brand-500">500+</div><div class="text-xs uppercase tracking-wide text-ink-400 mt-1">Properties Managed</div></div>
            <div><div class="text-3xl font-heading font-extrabold text-brand-500">98%</div><div class="text-xs uppercase tracking-wide text-ink-400 mt-1">Client Satisfaction</div></div>
            <div><div class="text-3xl font-heading font-extrabold text-brand-500">7+</div><div class="text-xs uppercase tracking-wide text-ink-400 mt-1">Years of Excellence</div></div>
